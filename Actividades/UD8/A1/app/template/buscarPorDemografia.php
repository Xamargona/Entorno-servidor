<?php ob_start() ?>
<form name="formBusqueda" action="index.php?accion=buscarPorDemografia" method="post">
...
<?php if (count($params['resultado'])>0): ?>
	<table>
		<tr>
			...
			<th>
				Fecha de estreno
				<a href="index.php?accion=buscarPorDemografia&demografia=<?=$params['demografia']?>&order=estreno&by=asc"><img src="img/interfaz/asc.png" alt="orden ascendiente" class="imgorden"></a>
				<a href="index.php?accion=buscarPorDemografia&demografia=<?=$params['demografia']?>&order=estreno&by=desc"><img src="img/interfaz/desc.png" alt="orden descendiente" class="imgorden"></a>
			</th>
