...
class Red
{
	 ...
	 *
 	 * Ejemplo: <b>$user = $red->selectUser(1);</b>
	 *
	 * @param int $id identificador de usuario
	 * @return User Devuelve un objeto usuario o null si no existe
	 */
	 ...
	 *
	 * @param int $id identificador de usuario
	 * @return Revel[] Devuelve array con todos los revel del usuario
	 */
	 ...
	 *
	 * @param int $id identificador de usuario 
	 * @return User[] Devuelve array con todos los usuarios a los que sigue
	 */
	 ...
	 * @return Revel Devuelve un Objeto revel o null si no existe
	 */
	 ...
	 * @return Comment Devuelve un Objeto comentario o null si no existe
	 */
	 ...
	 *
	 * @param int $id identificador de revel
	 * @return Comment[] Devuelve un array con todos los comentarios de un revel
	 */
	 ...
	 *
	 * @param int $id identificador de usuario 
	 * @return Revel[] Devuelve un array con los revels del tablon del usuario
	 */
	 ...
	 * @return User[] Devuelve un array con todos los usuarios que coincidan
	 */
 ...
 *
 * @author Álex Torres
 * @property int $user identificador del usuario
 * @property string $name nombre del usuario
 * @property string $pass contraseña del usuario
 * @property string $mail mail del usuario
 */
class User
{
	/**
 ...
 *
 * @author Álex Torres
 * @property int $id identificador de la revel
 * @property int $userId identificador del usuario
 * @property string $text contenido del comentario
 * @property int $timestamp fecha y hora del comentario
 */
class Revel
{
	/**
 ...
 *
 * @author Álex Torres
 * @property int $id identificador del comentario
 * @property int $revelId identificador de la revel
 * @property int $userId identificador del usuario
 * @property string $text contenido del comentario
 * @property int $timestamp fecha y hora del comentario
 */
 ...
 * @author Álex Torres
 * @property int $userId identificador del usuario
 * @property int $followedId identificador del usuario a seguir
 */
class Follow
{
	/**
